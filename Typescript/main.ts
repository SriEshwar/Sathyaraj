//windows + r  
//g:                  -> got to the path
//cd [path name]      -> to change the terminal path
//code main.ts        -> to create a file in vs
//tsc [file name]     -> to convert the typescript file to javascript file
//node [file name]    -> to print the output
