...
export class AccountComponent {
  ...
  accountHolders: AccountHolder[] = [
    new AccountHolder(123456789, "Sathya", "Savings", 10000.0, "2024-05-15", "Canara-Bank"),
    new AccountHolder(987654321, "Raj", "BusinessAccount", 20000.0, "2024-05-16", "SBI"),
    new AccountHolder(987994321, "Selvi", "SalaryAccount", 40000.0, "2024-08-16", "IndianOverseasBank"),
    new AccountHolder(123456089, "Tamil", "Savings", 15000.0, "2024-06-15", "Canara-Bank"),
